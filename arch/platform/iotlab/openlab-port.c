...
/* platform_reset_cause is defined and actually populated (from the real
 * RCC reset-cause register) in openlab/platform/iotlab-m3/iotlab-m3.c --
 * this was a redundant, always-zero duplicate declaration. */
